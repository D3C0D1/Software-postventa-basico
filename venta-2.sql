...
--
-- Servidor: localhost
-- Tiempo de generación: 07-11-2025 a las 18:06:16
...
CREATE TABLE `clientes` (
  `id` int NOT NULL,
  `dni` varchar(8) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `nombre` varchar(180) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
...
(1, '1234598', 'Daniel Florez', '924878', 'Sincelejo - Sucre'),
(2, '1', 'dany', '3184483187', '12');
...
(1, 64866912, 'Mi Rancheria', 925491523, 'Sincelejo - Sucre', 'Hello');
...
(1, '998787', 'Open Services', '798978879', 'Sincelejo - Sucre'),
(2, '1', 'ada', '31231', 'sd');
...
(1, 'invitado', 'invitado@gmail.com', 'admin', 'Administrador'),
(2, 'Administrador - Daniel Florez', 'admin@gmail.com', 'admin', 'Administrador');
...
CREATE TABLE `ventas` (
  ...
  `vendedor` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `total` decimal(10,2) NOT NULL,
  `fecha` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
...
(4, 1, 'Daniel Florez', 15000.00, '25/07/2021'),
(5, 2, 'Administrador - Daniel Florez', 200.00, '05/11/2025');
